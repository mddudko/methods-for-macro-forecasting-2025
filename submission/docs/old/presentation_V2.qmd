...
- process: lag, matrix, check multi-colinearity, weight

## Work in Progress
- extension: economic indicator
- midas: adding different models, i.e. generalised, unrestricted, non-parametric, etc.
- cross validation: expanding window implemented

## Questions:
- How much detail should we each go into our own approaches?
